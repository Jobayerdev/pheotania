...
let RolePermissionService = class RolePermissionService extends base_1.BaseService {
    constructor(rolePermissionRepository) {
        super(rolePermissionRepository, role_premission_entity_1.RolePermission.name);
